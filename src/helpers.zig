...
pub const map_lookup_elem = @as(fn (map: *const kern.MapDef, key: ?*const void) ?*void, @ptrFromInt(1));
pub const map_update_elem = @as(fn (map: *const kern.MapDef, key: ?*const void, value: ?*const void, flags: u64) c_long, @ptrFromInt(2));
pub const map_delete_elem = @as(fn (map: *const kern.MapDef, key: ?*const void) c_long, @ptrFromInt(3));
pub const probe_read = @as(fn (dst: ?*void, size: u32, unsafe_ptr: ?*const void) c_long, @ptrFromInt(4));
...
pub const skb_store_bytes = @as(fn (skb: *kern.SkBuff, offset: u32, from: ?*const void, len: u32, flags: u64) c_long, @ptrFromInt(9));
...
pub const tail_call = @as(fn (ctx: ?*void, prog_array_map: *const kern.MapDef, index: u32) c_long, @ptrFromInt(12));
...
pub const get_current_comm = @as(fn (buf: ?*void, size_of_buf: u32) c_long, @ptrFromInt(16));
...
pub const perf_event_output = @as(fn (ctx: ?*void, map: *const kern.MapDef, flags: u64, data: ?*void, size: u64) c_long, @ptrFromInt(25));
pub const skb_load_bytes = @as(fn (skb: ?*void, offset: u32, to: ?*void, len: u32) c_long, @ptrFromInt(26));
pub const get_stackid = @as(fn (ctx: ?*void, map: *const kern.MapDef, flags: u64) c_long, @ptrFromInt(27));
...
pub const skb_get_tunnel_opt = @as(fn (skb: *kern.SkBuff, opt: ?*void, size: u32) c_long, @ptrFromInt(29));
pub const skb_set_tunnel_opt = @as(fn (skb: *kern.SkBuff, opt: ?*void, size: u32) c_long, @ptrFromInt(30));
// proto is __be16
...
pub const skb_under_cgroup = @as(fn (skb: *kern.SkBuff, map: ?*const void, index: u32) c_long, @ptrFromInt(33));
pub const get_hash_recalc = @as(fn (skb: *kern.SkBuff) u32, @ptrFromInt(34));
pub const get_current_task = @as(fn () u64, @ptrFromInt(35));
pub const probe_write_user = @as(fn (dst: ?*void, src: ?*const void, len: u32) c_long, @ptrFromInt(36));
...
pub const probe_read_str = @as(fn (dst: ?*void, size: u32, unsafe_ptr: ?*const void) c_long, @ptrFromInt(45));
pub const get_socket_cookie = @as(fn (ctx: ?*void) u64, @ptrFromInt(46));
...
pub const setsockopt = @as(fn (bpf_socket: *kern.SockOps, level: c_int, optname: c_int, optval: ?*void, optlen: c_int) c_long, @ptrFromInt(49));
...
pub const sock_map_update = @as(fn (skops: *kern.SockOps, map: *const kern.MapDef, key: ?*void, flags: u64) c_long, @ptrFromInt(53));
...
pub const getsockopt = @as(fn (bpf_socket: ?*void, level: c_int, optname: c_int, optval: ?*void, optlen: c_int) c_long, @ptrFromInt(57));
...
pub const get_stack = @as(fn (ctx: ?*void, buf: ?*void, size: u32, flags: u64) c_long, @ptrFromInt(67));
pub const skb_load_bytes_relative = @as(fn (skb: ?*const void, offset: u32, to: ?*void, len: u32, start_header: u32) c_long, @ptrFromInt(68));
pub const fib_lookup = @as(fn (ctx: ?*void, params: *kern.FibLookup, plen: c_int, flags: u32) c_long, @ptrFromInt(69));
pub const sock_hash_update = @as(fn (skops: *kern.SockOps, map: *const kern.MapDef, key: ?*void, flags: u64) c_long, @ptrFromInt(70));
pub const msg_redirect_hash = @as(fn (msg: *kern.SkMsgMd, map: *const kern.MapDef, key: ?*void, flags: u64) c_long, @ptrFromInt(71));
pub const sk_redirect_hash = @as(fn (skb: *kern.SkBuff, map: *const kern.MapDef, key: ?*void, flags: u64) c_long, @ptrFromInt(72));
pub const lwt_push_encap = @as(fn (skb: *kern.SkBuff, typ: u32, hdr: ?*void, len: u32) c_long, @ptrFromInt(73));
pub const lwt_seg6_store_bytes = @as(fn (skb: *kern.SkBuff, offset: u32, from: ?*const void, len: u32) c_long, @ptrFromInt(74));
pub const lwt_seg6_adjust_srh = @as(fn (skb: *kern.SkBuff, offset: u32, delta: i32) c_long, @ptrFromInt(75));
pub const lwt_seg6_action = @as(fn (skb: *kern.SkBuff, action: u32, param: ?*void, param_len: u32) c_long, @ptrFromInt(76));
pub const rc_repeat = @as(fn (ctx: ?*void) c_long, @ptrFromInt(77));
pub const rc_keydown = @as(fn (ctx: ?*void, protocol: u32, scancode: u64, toggle: u32) c_long, @ptrFromInt(78));
pub const skb_cgroup_id = @as(fn (skb: *kern.SkBuff) u64, @ptrFromInt(79));
pub const get_current_cgroup_id = @as(fn () u64, @ptrFromInt(80));
pub const get_local_storage = @as(fn (map: ?*void, flags: u64) ?*void, @ptrFromInt(81));
pub const sk_select_reuseport = @as(fn (reuse: *kern.SkReusePortMd, map: *const kern.MapDef, key: ?*void, flags: u64) c_long, @ptrFromInt(82));
pub const skb_ancestor_cgroup_id = @as(fn (skb: *kern.SkBuff, ancestor_level: c_int) u64, @ptrFromInt(83));
pub const sk_lookup_tcp = @as(fn (ctx: ?*void, tuple: *kern.SockTuple, tuple_size: u32, netns: u64, flags: u64) ?*kern.Sock, @ptrFromInt(84));
pub const sk_lookup_udp = @as(fn (ctx: ?*void, tuple: *kern.SockTuple, tuple_size: u32, netns: u64, flags: u64) ?*kern.Sock, @ptrFromInt(85));
pub const sk_release = @as(fn (sock: *kern.Sock) c_long, @ptrFromInt(86));
pub const map_push_elem = @as(fn (map: *const kern.MapDef, value: ?*const void, flags: u64) c_long, @ptrFromInt(87));
pub const map_pop_elem = @as(fn (map: *const kern.MapDef, value: ?*void) c_long, @ptrFromInt(88));
pub const map_peek_elem = @as(fn (map: *const kern.MapDef, value: ?*void) c_long, @ptrFromInt(89));
...
pub const rc_pointer_rel = @as(fn (ctx: ?*void, rel_x: i32, rel_y: i32) c_long, @ptrFromInt(92));
...
pub const skc_lookup_tcp = @as(fn (ctx: ?*void, tuple: *kern.SockTuple, tuple_size: u32, netns: u64, flags: u64) ?*kern.Sock, @ptrFromInt(99));
pub const tcp_check_syncookie = @as(fn (sk: *kern.Sock, iph: ?*void, iph_len: u32, th: *TcpHdr, th_len: u32) c_long, @ptrFromInt(100));
...
pub const sk_storage_get = @as(fn (map: *const kern.MapDef, sk: *kern.Sock, value: ?*void, flags: u64) ?*void, @ptrFromInt(107));
...
pub const tcp_gen_syncookie = @as(fn (sk: *kern.Sock, iph: ?*void, iph_len: u32, th: *TcpHdr, th_len: u32) i64, @ptrFromInt(110));
pub const skb_output = @as(fn (ctx: ?*void, map: *const kern.MapDef, flags: u64, data: ?*void, size: u64) c_long, @ptrFromInt(111));
pub const probe_read_user = @as(fn (dst: ?*void, size: u32, unsafe_ptr: ?*const void) c_long, @ptrFromInt(112));
pub const probe_read_kernel = @as(fn (dst: ?*void, size: u32, unsafe_ptr: ?*const void) c_long, @ptrFromInt(113));
pub const probe_read_user_str = @as(fn (dst: ?*void, size: u32, unsafe_ptr: ?*const void) c_long, @ptrFromInt(114));
pub const probe_read_kernel_str = @as(fn (dst: ?*void, size: u32, unsafe_ptr: ?*const void) c_long, @ptrFromInt(115));
pub const tcp_send_ack = @as(fn (tp: ?*void, rcv_nxt: u32) c_long, @ptrFromInt(116));
pub const send_signal_thread = @as(fn (sig: u32) c_long, @ptrFromInt(117));
pub const jiffies64 = @as(fn () u64, @ptrFromInt(118));
pub const read_branch_records = @as(fn (ctx: *kern.PerfEventData, buf: ?*void, size: u32, flags: u64) c_long, @ptrFromInt(119));
pub const get_ns_current_pid_tgid = @as(fn (dev: u64, ino: u64, nsdata: *kern.PidNsInfo, size: u32) c_long, @ptrFromInt(120));
pub const xdp_output = @as(fn (ctx: ?*void, map: *const kern.MapDef, flags: u64, data: ?*void, size: u64) c_long, @ptrFromInt(121));
pub const get_netns_cookie = @as(fn (ctx: ?*void) u64, @ptrFromInt(122));
...
pub const seq_printf = @as(fn (m: *kern.SeqFile, fmt: ?*const u8, fmt_size: u32, data: ?*const void, data_len: u32) c_long, @ptrFromInt(126));
...
pub const ringbuf_output = @as(fn (ringbuf: ?*void, data: ?*void, size: u64, flags: u64) ?*void, @ptrFromInt(130));
pub const ringbuf_reserve = @as(fn (ringbuf: ?*void, size: u64, flags: u64) ?*void, @ptrFromInt(131));
pub const ringbuf_submit = @as(fn (data: ?*void, flags: u64) void, @ptrFromInt(132));
pub const ringbuf_discard = @as(fn (data: ?*void, flags: u64) void, @ptrFromInt(133));
pub const ringbuf_query = @as(fn (ringbuf: ?*void, flags: u64) u64, @ptrFromInt(134));
pub const csum_level = @as(fn (skb: *kern.SkBuff, level: u64) c_long, @ptrFromInt(134));
pub const skc_to_tcp6_sock = @as(fn (sk: ?*void) ?*kern.Tcp6Sock, @ptrFromInt(135));
pub const skc_to_tcp_sock = @as(fn (sk: ?*void) ?*kern.TcpSock, @ptrFromInt(136));
pub const skc_to_tcp_timewait_sock = @as(fn (sk: ?*void) ?*kern.TcpTimewaitSock, @ptrFromInt(137));
pub const skc_to_tcp_request_sock = @as(fn (sk: ?*void) ?*kern.TcpRequestSock, @ptrFromInt(138));
pub const skc_to_udp6_sock = @as(fn (sk: ?*void) ?*kern.Udp6Sock, @ptrFromInt(139));
pub const get_task_stack = @as(fn (task: ?*void, buf: ?*void, size: u32, flags: u64) c_long, @ptrFromInt(140));
